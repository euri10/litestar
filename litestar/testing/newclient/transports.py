...
from httpx import AsyncBaseTransport, BaseTransport, ByteStream, Request, Response

from litestar.status_codes import HTTP_500_INTERNAL_SERVER_ERROR
from litestar.testing import WebSocketTestSession
from litestar.testing.transport import ConnectionUpgradeExceptionError, SendReceiveContext
...
class MyBaseTestClientTransport(Generic[T_App]):
    def __init__(
        self,
        client: T_App,
...
class MyASGISyncTransport(MyBaseTestClientTransport, BaseTransport):
    """A custom synchronous transport for Litestar testing.
    Inherits from httpx.BaseTransport.
    """
...
class MyASGIAsyncTransport(MyBaseTestClientTransport, AsyncBaseTransport):
    """A custom asynchronous transport for Litestar testing.
    Inherits from httpx.AsyncBaseTransport.
    """
